...
#define CHIP_NAME_STM32H743VGTX
...
#define BSP_SPI2_SCK_PIN     GET_PIN(B, 13)
#define BSP_SPI2_MOSI_PIN    GET_PIN(B, 15)
#define BSP_SPI2_MISO_PIN    GET_PIN(B, 14)
...
// 电机1 (左)
#define MOTOR1_DIR_PLUS     GET_PIN(E, 10)   // 方向+
#define MOTOR1_DIR_MINUS    GET_PIN(E, 11)   // 方向-
#define MOTOR1_ENA          GET_PIN(E, 3)    // 使能 (ENA-)
#define MOTOR1_PULSE_POS    GET_PIN(E, 9)    // 脉冲+ (TIM1_CH1)
#define MOTOR1_PULSE_NEG    GET_PIN(E, 8)    // 脉冲- (接地)

// 电机2 (右)
#define MOTOR2_DIR_PLUS     GET_PIN(E, 14)   // 方向+
#define MOTOR2_DIR_MINUS    GET_PIN(E, 15)   // 方向-
#define MOTOR2_ENA          GET_PIN(E, 4)    // 使能 (ENA-)
#define MOTOR2_PULSE_POS    GET_PIN(A, 5)    // 脉冲+ (TIM2_CH1)
#define MOTOR2_PULSE_NEG    GET_PIN(E, 12)   // 脉冲- (接地)
